package com.tianxuan.makeup.aspect;
...
public class SellerAuthorizeAspect {
    ...
    @Pointcut("execution(public * com.tianxuan.makeup.controller.Seller*.*(..))" +
    "&& !execution(public * com.tianxuan.makeup.controller.SellerUserController.*(..) )")
    public void verify(){
